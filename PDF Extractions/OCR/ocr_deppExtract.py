...
class OCRProcessor:
    ...
    def stop_ollama_model(self, model_name):
        if self.is_model_running(model_name):
            ...
            print(f"ℹ️ Model '{model_name}' is not running.")
    ...
    def _pdf_to_images(self, pdf_path: str) -> List[str]:
        ...
        try:
            ...
            for page_num in range(doc.page_count):
                ...
                temp_path = f"{pdf_path}_page{page_num}.png"
...
processor = OCRProcessor(model_name=model_name, max_workers=1)
result = processor.process_image(image_path=path, format_type="markdown")
# print(result)
processor.stop_ollama_model(model_name)
pathlib.Path("output.md").write_bytes(result.encode())
